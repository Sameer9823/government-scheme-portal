    ...
    <div className="min-h-screen flex flex-col items-center">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white">
          Government Schemes <span className="bg-gradient-to-r from-orange-500 via-indigo-500 to-green-500 text-transparent bg-clip-text">Bot</span>
        </h1>
      ...
      <div className="w-full max-w-5xl rounded-lg shadow-2xl bg-gray-800 text-white flex flex-col h-[700px]">
        <div className="bg-gray-700 text-white text-center p-4 rounded-t-lg border-b">
          <h1 className="text-2xl font-bold">Ask any Schemes</h1>
          <p className="text-sm bg-gradient-to-r from-orange-500 via-indigo-500 to-green-500 text-transparent bg-clip-text">Powered by GOI</p>
        </div>
