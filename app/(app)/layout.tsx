...
import img from "@/app/fonts/lg.jpg"
...
const sidebarItems = [
  ...
  { href: "/social-share", icon: Newspaper, label: "News" },
  { href: "/video-upload", icon: SwatchBook, label: "Schemes" },
  { href: "/cloudGPT", icon: Bot, label: "Chat Bot" },
